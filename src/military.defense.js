...
function earlyWarning(room) {
    let adjacent = _.filter(Game.map.describeExits(room.name), (r) => Memory.roomCache[r] && Memory.roomCache[r].threatLevel >= 3 && !Memory.roomCache[r].sk && !Memory.roomCache[r].isHighway)[0];
    if (adjacent) {
