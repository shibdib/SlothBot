Creep.prototype.scoutRoom = function () {
    ...
    let towers = _.filter(this.room.structures, (s) => s.structureType === STRUCTURE_TOWER && !_.includes(FRIENDLIES, s.owner.username));
    let ramparts = _.filter(this.room.structures, (s) => s.structureType === STRUCTURE_RAMPART && !_.includes(FRIENDLIES, s.owner.username));
