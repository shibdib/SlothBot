...
function shibMove(creep, heading, options = {}) {
    ...
    if (!creep.memory._shibMove || Math.random() > options.repathChance || options.forceRepath || (creep.memory._shibMove.path && creep.memory._shibMove.path.length < 1)) creep.memory._shibMove = {};
