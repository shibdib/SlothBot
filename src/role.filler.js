...
module.exports.role = function (creep) {
    ...
    if (creep.memory.hauling) {
        // Hub Container
        let hubContainer = Game.getObjectById(creep.room.memory.hubContainer) || creep.room.storage || Game.getObjectById(creep.findStorage()) || Game.getObjectById(creep.findSpawnsExtensions());
        if (hubContainer) {
