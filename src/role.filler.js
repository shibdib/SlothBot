...
module.exports.role = function (creep) {
    ...
    if (creep.memory.hauling) {
        // Hub Container
        let hubContainer = Game.getObjectById(creep.room.memory.hubContainer) || creep.room.storage || Game.getObjectById(creep.findStorage()) || _.filter(creep.room.structures, (s) => s.structureType === STRUCTURE_SPAWN)[0];
        if (hubContainer) {
