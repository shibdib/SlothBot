...
function linkControl(room) {
    ...
    if (!Game.getObjectById(room.memory.storageLink)) room.memory.storageLink = undefined;
    if (!Game.getObjectById(room.memory.controllerLink)) room.memory.controllerLink = undefined;
