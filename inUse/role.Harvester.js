...
function role(creep) {
    ...
    if (creep.room.controller.level >= 4 && creep.room.energyAvailable >= 500 && creep.ticksToLive < 100 && renewers.length < 2 || (creep.memory.renewing && creep.room.energyAvailable >= 300)) {
