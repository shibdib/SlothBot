            ...
            if (!Game.spawns[spawnName].spawning) {
                ...
                if (Game.spawns[spawnName].room.energyAvailable >= 2300) {
                    for (let i = 0; i < minerals.length; i++) {
                        ...
                        if ((harvester.length < 2 || harvester.ticksToLive < 150) && Game.spawns[spawnName].createCreep([MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY], generatedNumber + 'mineralHarvester', {
