...
module.exports.towerControl = function (room) {
    ...
    if (!hostileCreeps.length && repairTower) {
        ...
        let degrade = _.filter(room.structures, (s) => (s.structureType === STRUCTURE_ROAD && s.hits < s.hitsMax * 0.5) || (s.structureType === STRUCTURE_CONTAINER && s.hits < s.hitsMax * 0.5))[0];
            ...
            if (nukeRampart) {
                ...
                for (let tower of towers) tower.repair(nukeRampart);
                                                                          ...
                                                                          if (
                                                                            ...
                                                                            return repairTower.repair(
                                                                              barriers
                                                                            );
                                                                          } else if (
                                                                            repairTower.energy >
                                                                              repairTower.energyCapacity *
                                                                                0.7 &&
                                                                            repairTower
                                                                              .room
                                                                              .energyState
