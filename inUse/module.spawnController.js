        ...
        for (let name in Game.flags) {
            ...
            if (_.startsWith(name, 'attack')) {
                ...
                if (Game.flags['staging' + staging].pos.roomName === spawn.pos.roomName || multiRoom === '1') {
                    ...
                    if ((attackers.length < attackerAmount || attackers[0].ticksToLive < 150) && spawn.createCreep(Memory.creepBodies[level].attacker, 'attacker' + Game.time, {
                            role: 'attacker',
                            assignedSpawn: spawn.id,
                            assignedRoom: spawn.room.name,
                    ...
                    if ((healer.length < healerAmount || healer[0].ticksToLive < 150) && spawn.createCreep(Memory.creepBodies[level].healer, 'healer' + Game.time, {
                            role: 'healer',
                            assignedSpawn: spawn.id,
                            assignedRoom: spawn.room.name,
                            attackTarget: Game.flags[name].name,
                    ...
                    if (spawn.room.controller.level >= 5) {
                        ...
                        if ((ranged.length < rangedAmount || ranged[0].ticksToLive < 150) && spawn.createCreep(Memory.creepBodies[level].ranged, 'ranged' + Game.time, {
                                role: 'ranged',
                                assignedSpawn: spawn.id,
                                assignedRoom: spawn.room.name,
                                attackTarget: Game.flags[name].name,
                        ...
                        if ((deconstructor.length < deconstructorAmount || deconstructor[0].ticksToLive < 150) && spawn.createCreep(Memory.creepBodies[level].deconstructor, 'deconstructor' + Game.time, {
                                role: 'deconstructor',
                                assignedSpawn: spawn.id,
                                assignedRoom: spawn.room.name,
                                attackTarget: Game.flags[name].name,
