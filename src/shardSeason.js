...
global.MANUAL_FRIENDS = ['mawif', 'Genovese', 'Trepidimous', 'Kasami']; // Manually set players as friends (overrides COMBAT_SERVER)
...
// Seasonal Specific
global.SEASON_RCL_CUTOFF = 7; // Only score in rooms greater than or equal to this
...
global.FACTORY_CUTOFF = ENERGY_AMOUNT * 0.1; // Amount needed for a factory to be active
