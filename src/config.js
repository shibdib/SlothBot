...
global.RESERVE_ROOM_SIGNS = [
  "~~This is a restricted area, violators will be attacked~~",
  "~~Exclusion Zone~~",
];
global.EXPLORED_ROOM_SIGNS = [
  "Automated Exploration Occurred Here",
  "Just saying Hi!",
  "We Know",
  "Intel gathered, enter at your own risk.",
];
...
global.MINERAL_TRADE_AMOUNT =
  TERMINAL_CAPACITY * 0.015 + STORAGE_CAPACITY * 0.015; // Hold this much of a mineral before selling
...
global.ENERGY_MARKET_BASELINE = 0.01;
