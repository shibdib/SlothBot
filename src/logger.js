...
class Log {
  ...
  i(message, custom = undefined) {
    if (custom) this.cprint(custom + " " + message, this.LOGGING_LEVEL.INFO);
    else this.cprint("INFO: " + message, this.LOGGING_LEVEL.INFO);
  }
  ...
  w(message, custom = undefined) {
    ...
    else this.cprint("WARN: " + message, this.LOGGING_LEVEL.WARN, "#f43e6d");
  }
  ...
  e(message, custom = undefined) {
    ...
    else this.cprint("ERROR: " + message, this.LOGGING_LEVEL.ERROR, "#e59821");
  }
  ...
  a(message, custom = undefined) {
    ...
    else this.cprint("ALERT: " + message, this.LOGGING_LEVEL.ALERT, "#00ff07");
  }
